...
function App() {
  ...
  return (
    <>
      ...
      <main style={{ maxWidth: 900, margin: '0 auto', padding: '40px 20px', display: 'flex', flexDirection: 'column', gap: 48 }}>
        ...
        <section>
          ...
          <div style={{ marginTop: 20, textAlign: 'center' }}>
            <a href="https://github.com/phucbm/react-hanzi-input#readme" target="_blank" rel="noopener noreferrer"
              ...
              Full docs &amp; installation guide on GitHub
            </a>
          </div>
        </section>
      ...
      <footer style={{ borderTop: '1px solid var(--border)', padding: '24px 20px', textAlign: 'center', color: 'var(--muted)', fontSize: 12, lineHeight: 1.8 }}>
        <div>
        ...
        <div>
          Inspired by{' '}
          <a href="https://github.com/icelam/chinese-handwriting-recognition" target="_blank" rel="noopener noreferrer">
            icelam/chinese-handwriting-recognition
          </a>
        </div>
      </footer>
    </>
