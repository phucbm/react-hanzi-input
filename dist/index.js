...
var HanziPad = react.forwardRef(
  function HanziPad2({ onStrokesChange, width = 280, height = 280, strokeColor = "#1a1a1a", lineWidth = 3, background = "#ffffff", showGrid = true, gridLines = 2, gridColor = "#d1d5db", className, style }, ref) {
    ...
    const drawGrid = react.useCallback((ctx) => {
      if (!showGrid) return;
      const fractions = {
        1: [0.5],
        2: [1 / 3, 2 / 3],
...
function HanziInput({
  ...
  const handleStrokesChange = react.useCallback((strokes) => setStrokeCount(strokes.length), []);
  const handleRecognize = react.useCallback(async () => {
    var _a, _b;
  ...
  const handleSelect = react.useCallback((character) => {
    onSelect(character);
    handleClear();
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className, style: { display: "inline-flex", flexDirection: "column", gap: 8 }, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", gap: 6 }, children: [
      showUndo && /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", onClick: handleUndo, disabled: strokeCount === 0, style: btn, children: "Undo" }),
      showClear && /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", onClick: handleClear, disabled: strokeCount === 0, style: btn, children: "Clear" }),
      /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", onClick: handleRecognize, disabled: strokeCount === 0 || loading, style: __spreadProps(__spreadValues({}, btn), { marginLeft: "auto", fontWeight: 500 }), children: loading ? "\u2026" : "Recognize" })
    ] }),
    error && /* @__PURE__ */ jsxRuntime.jsx("p", { style: { margin: 0, fontSize: 12, color: "#dc2626" }, children: error }),
    candidates.length > 0 && /* @__PURE__ */ jsxRuntime.jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: 6 }, children: candidates.map((c, i) => /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
        type: "button",
...
exports.HanziInput = HanziInput;
exports.HanziPad = HanziPad;
exports.createHandwritingRoute = createHandwritingRoute;
exports.recognize = recognize;
exports.recognizeDirect = recognizeDirect;
